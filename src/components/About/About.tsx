    ...
    <section id="about" className="bg-gray-100 py-16">
      <MaxWidthWrapper>
        <section className="text-center px-10">
          <div className="pb-10">
            <h1 className="font-bold text-4xl text-center my-4">About Me</h1>
            <p className="text-gray-600 text-sm text-center">My introduction</p>
          </div>
          ...
          <div className="md:flex justify-center gap-12">
            <Image
              ...
              src="/about.png"
              alt="profile"
              className="h-72 rounded-3xl mx-auto"
            />
            <div className="">
              <AboutInfo />
              <div className="text-left">
                ...
                <a href="/zarifullahniazi.pdf" download>
                  <Button className="px-5 py-4 flex flex-start my-4">
                    Download CV{"  "}
                    <svg
                      className="ml-2"

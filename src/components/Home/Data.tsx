...
const Data = (props: Props) => {
  return (
    <section>
      <div className="md:flex mx-14 justify-between items-center my-14">
        <div className="md:w-1/2 space-y-6">
          <div className="flex space-x-4 mt-44 mb-4 items-center">
            <h1 className="text-4xl md:text-5xl font-semibold animate-fade-in-right duration-600">
              Zarifullah Niazi
            </h1>
            <svg
              width="36"
          ...
          <div className="flex items-center mt-1">
            <div className="inline-block h-[1px] w-16 bg-gray-600 mr-2"></div>
            <h3>Software Engineer & Visual Designer</h3>
          </div>
          <p className="text-md text-gray-900">
            I m an aispring software developer and product designer based in
            Kabul, Afghanistan, very passionate and dedicated to my work.
          </p>
          <a
            className="mt-3"
            href="https://wa.me/+93788081503?text=Hi"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Button className="px-10 py-8 rounded-3xl mt-3">
              Say Hello
              <svg
                className="ml-2"
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
          <Image
            ...
            alt="profile"
            src="/about.png"
            className="h-72 w-72 rounded-full mt-32 mr-12 hidden md:block"
          />
        </div>
      </div>
      <div className="md:flex hidden ml-12 my-12">
